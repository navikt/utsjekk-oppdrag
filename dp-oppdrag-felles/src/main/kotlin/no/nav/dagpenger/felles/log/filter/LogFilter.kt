package no.nav.dagpenger.felles.log.filter
...
import no.nav.dagpenger.felles.log.IdUtils
import no.nav.dagpenger.felles.log.NavHttpHeaders
import no.nav.dagpenger.felles.log.mdc.MDCConstants.MDC_CALL_ID
import no.nav.dagpenger.felles.log.mdc.MDCConstants.MDC_CONSUMER_ID
import no.nav.dagpenger.felles.log.mdc.MDCConstants.MDC_REQUEST_ID
import no.nav.dagpenger.felles.log.mdc.MDCConstants.MDC_USER_ID
