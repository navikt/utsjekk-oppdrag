package no.nav.utsjekk.felles.log.filter
...
import no.nav.utsjekk.felles.log.IdUtils
import no.nav.utsjekk.felles.log.NavHttpHeaders
import no.nav.utsjekk.felles.log.mdc.MDCConstants.MDC_CALL_ID
import no.nav.utsjekk.felles.log.mdc.MDCConstants.MDC_CONSUMER_ID
import no.nav.utsjekk.felles.log.mdc.MDCConstants.MDC_REQUEST_ID
import no.nav.utsjekk.felles.log.mdc.MDCConstants.MDC_USER_ID
