...
private fun enSimulerBeregningResponse(request: SimulerBeregningRequest, beregningsPerioder: List<BeregningsPeriode>) =
    SimulerBeregningResponse().apply {
        this.response = InnerSimulerBeregningResponse().apply {
...
private fun enBeregningsPeriode(bergeningStopNiva: List<BeregningStoppnivaa>, date: LocalDate) =
